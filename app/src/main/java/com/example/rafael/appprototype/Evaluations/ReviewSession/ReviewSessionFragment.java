package com.example.rafael.appprototype.Evaluations.ReviewSession;
...
public class ReviewSessionFragment extends Fragment {
     ...
     */
        DisplayTestCard adapter = new DisplayTestCard(getActivity(), testsList, session, resuming, patient);
