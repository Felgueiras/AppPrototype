...
public class PatientSessionCard extends RecyclerView.Adapter<PatientSessionCard.MyViewHolder> {
    ...
    public PatientSessionCard(Activity context, ArrayList<Session> sessions, Patient patient) {
