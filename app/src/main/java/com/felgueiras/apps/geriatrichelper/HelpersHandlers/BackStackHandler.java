...
import com.felgueiras.apps.geriatrichelper.CGAGuide.CGAGuideAreaFragment;
import com.felgueiras.apps.geriatrichelper.CGAGuide.CGAGuideScale;
...
import com.felgueiras.apps.geriatrichelper.Patients.PatientProfile.PatientPrescriptions.AddPrescriptions.PatientPrescriptionsAddFragment;
...
import com.felgueiras.apps.geriatrichelper.Sessions.DisplayTest.ScaleFragment;
...
import com.felgueiras.apps.geriatrichelper.Main.PrivateAreaMainFragment;
...
import com.felgueiras.apps.geriatrichelper.Sessions.ReviewSession.ReviewSingleTest.ReviewScaleFragment;
...
//            return;
            ...
            switch (tag) {
                case Constants.tag_display_session_scale: {
                    ...
                    SessionFirebase session = FirebaseDatabaseHelper.getSessionFromScale(scale);
...
//                    args.putSerializable(CGAAreaPublicBottomButtons.CGA_AREA, arguments.getSerializable(ScaleFragment.CGA_AREA));
                ...
                case Constants.tag_review_test: {
                    ...
                    SessionFirebase session = FirebaseDatabaseHelper.getSessionFromScale(test);
